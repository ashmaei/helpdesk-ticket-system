<section>
    ...
    <form method="post" action="{{ route('password.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            <x-input-label for="update_password_current_password" :value="__('Katalaluan Semasa')" />
        ...
        <div>
            <x-input-label for="update_password_password" :value="__('Katalaluan Baharu')" />
        ...
        <div>
            <x-input-label for="update_password_password_confirmation" :value="__('Sahkan Katalaluan')" />
